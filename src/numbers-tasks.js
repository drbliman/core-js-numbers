...
function getDistanceBetweenPoints(x1, y1, x2, y2) {
  return (Math.abs(y1 - y2) ** 2 + Math.abs(x1 - x2) ** 2) ** (1 / 2);
}
...
function getAngleBetweenVectors(x1, y1, x2, y2) {
  const l1 = (Math.abs(x1) ** 2 + Math.abs(y1) ** 2) ** (1 / 2);
  const l2 = (Math.abs(x2) ** 2 + Math.abs(y2) ** 2) ** (1 / 2);
